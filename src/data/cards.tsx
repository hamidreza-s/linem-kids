...
export const createCardContent = (gray500: string, handlePromptClick: () => void) => {
  const mockData = [
    {
      content: [
      ...
      getOptions: (cardId: number) => (
        <Box display="flex" gap="4" mt="4" mb="4">
          <NumberButton number={1} cardId={cardId} />
          <NumberButton number={2} cardId={cardId} />
          <NumberButton number={3} cardId={cardId} />
          <IconButton 
